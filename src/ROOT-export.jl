...
export GetEventY, GetExpFormula, GetExpectedType, GetFPEMask, GetFd, GetFile, GetFileName, GetFileNumber, GetFirst, GetFirstEntry
export GetFlagsDebug, GetFlagsOpt, GetForceStyle, GetFormula, GetFriend, GetFriendAlias, GetFromPipe, GetFsInfo, GetFullName
export GetFunction, GetGeometry, GetGid, GetGitBranch, GetGitCommit, GetGitDate, GetGroupInfo, GetHighLightColor, GetHistogram
export GetHomeDirectory, GetHostByName, GetIOFeatures, GetIconName, GetIdleCommand, GetImplicitMT, GetIncludePath, GetIndex
export GetIndexValues, GetIntegral, GetInterpreter, GetIteratorOnAllLeaves, GetKeep, GetKey, GetKeylen, GetKurtosis, GetLabelColor
export GetLabelFont, GetLabelOffset, GetLabelSize, GetLast, GetLeaf, GetLeafCount, GetLeafCounter, GetLen, GetLenStatic, GetLenType
export GetLibraries, GetLinearPart, GetLinkdefSuffix, GetLinkedLibs, GetList, GetListOfAliases, GetListOfBaskets, GetListOfBranches
...
export GetListOfTypes, GetLists, GetLowEdge, GetMakeClass, GetMakeExe, GetMakeSharedLib, GetMaxBaskets, GetMaxEntryLoop, GetMaxSize
...
export GetMoreLogLabels, GetMother, GetMotherDir, GetN, GetNDF, GetNProcessIDs, GetName, GetNbins, GetNbinsX, GetNbinsY, GetNbinsZ
...
export GetSelectedOpt, GetSelectedPad, GetSelectedPrimitive, GetSelectedRows, GetSelectedX, GetSelectedY, GetServiceByName
export GetServiceByPort, GetSetup, GetShowEditor, GetShowEventStatus, GetShowToolBar, GetShowToolTips, GetSignalHandler, GetSize
export GetSkewness, GetSoExt, GetSockName, GetSockOpt, GetSplitLevel, GetStartEntry, GetStatOverflows, GetStats, GetStdDev
export GetStdDevError, GetStreamerInfoCache, GetStreamerInfoList, GetSubBranch, GetSumOfWeights, GetSumw2, GetSumw2N, GetSysInfo
...
export GetTitle, GetTitleFont, GetTitleOffset, GetTitleSize, GetTotBytes, GetTotalSize, GetTransientBuffer, GetTree, GetTreeName
export GetTreeNumber, GetType, GetTypeName, GetUUID, GetUid, GetUniqueID, GetUpdate, GetUserInfo, GetV1, GetV2, GetV3, GetV4, GetVal
...
export SetNumberFitPoints, SetObjExt, SetObject, SetOffset, SetOption, SetPadSave, SetParError, SetParErrors, SetParLimits, SetParName
export SetParNames, SetParallelUnzip, SetParameter, SetParameters, SetParent, SetPoint, SetPointX, SetPointY, SetProgname, SetRange
export SetRangeUser, SetReadCalls, SetReadingObject, SetRealAspectRatio, SetReapplyCut, SetRefreshFlag, SetRetained
export SetReturnFromRun, SetSavedPoint, SetScanField, SetSeed, SetSeekDir, SetSelected, SetSelectedPad, SetSelectedPrimitive, SetShift
export SetShowProjectionX, SetShowProjectionXY, SetShowProjectionY, SetSoExt, SetSockOpt, SetStatOverflows, SetStats, SetStatus
export SetStatusText, SetStyle, SetSupportGL, SetTRefAction, SetTargetMemoryRatio, SetTickLength, SetTicks, SetTimeDisplay
export SetTimeFormat, SetTimeOffset, SetTimerInterval, SetTitle, SetTitleFont, SetTitleOffset, SetTitleSize, SetTree, SetTreeName
export SetTreeNumber, SetUniqueID, SetUnsigned, SetUpdate, SetVectorized, SetWebDisplay, SetWeight, SetWindowPosition, SetWindowSize
export SetWritable, SetXTitle, SetYTitle, SetZTitle, Setenv, SetupAddresses, Show, ShowBackground, ShowOutput, ShowPeaks
